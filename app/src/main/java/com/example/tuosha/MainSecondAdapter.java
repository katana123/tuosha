...
public class MainSecondAdapter extends BaseAdapter {
    ...
    public MainSecondAdapter(ArrayList<NewsBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView item_tv_date = (TextView) view.findViewById(R.id.pub_time);
        ...
        item_tv_date.setText(newsBean.newstime);
        read_count.setText(newsBean.readnum);
        return view;
    }
}
