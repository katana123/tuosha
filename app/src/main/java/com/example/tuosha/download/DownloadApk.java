package com.example.tuosha.download;
...
import com.example.tuosha.download.SystemParams;
...
public class DownloadApk {
    ...
    public static void removeFile(Context context) {
       // String filePath = SystemParams.getInstance().getString("downloadApk","/DownLoad");
        String filePath = Constants.TCP_SERVER_ADDRESS+"/DownLoad";
        if(null != filePath) {
